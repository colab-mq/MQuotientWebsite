      ...
      <div className="bg-gradient-to-r from-primary to-primary-dark text-white py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold" data-testid="text-page-title">Google Cloud Platform</h1>
          </div>
          <p className="text-xl max-w-3xl">
            Enterprise cloud solutions powered by Google Cloud
          </p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-muted/30 border border-border rounded-lg p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Detailed information about our Google Cloud solutions and services is currently being prepared. 
              Check back soon for comprehensive details about how mquotient can help you leverage Google Cloud for your enterprise.
            </p>
